 ...
 */
#define CFG_GAP_APPEARANCE            (GAP_APPEARANCE_BLOOD_PRESSURE_ARM)
...
typedef enum
{
  ...
  TASK_BUTTON_3,
  /* BLS Measurement */
  CFG_TASK_BLS_BP_MEAS_REQ_ID,
  CFG_TASK_BLS_BP_INT_CUFF_PRESSURE_REQ_ID,
  CFG_TASK_BLS_EBP_MEAS_REQ_ID,
  CFG_TASK_BLS_EBP_INT_CUFF_PRESSURE_REQ_ID,
