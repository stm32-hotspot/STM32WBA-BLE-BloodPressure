...
BLS_APP_ConnHandleNotEvt_t BLSHandleNotification;

static const char a_GapDeviceName[] = {  'B', 'l', 'o', 'o', 'd', ' ', 'P', 'r', 'e', 's', 's', 'u', 'r', 'e' }; /* Gap Device Name */

/* Advertising Data */
uint8_t a_AdvData[28] =
{
  7, AD_TYPE_COMPLETE_LOCAL_NAME, 'B', 'L', 'S', '_', 'X', 'X',  /* Complete name */
  3, AD_TYPE_16_BIT_SERV_UUID_CMPLT_LIST, 0x10, 0x18,
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      BLSHandleNotification.EvtOpcode = BLS_DISCON_HANDLE_EVT;
      DISHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      BLSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      DIS_APP_EvtRx(&DISHandleNotification);
      BLS_APP_EvtRx(&BLSHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          BLSHandleNotification.EvtOpcode = BLS_CONN_HANDLE_EVT;
          DISHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          BLSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          DIS_APP_EvtRx(&DISHandleNotification);
          BLS_APP_EvtRx(&BLSHandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          BLSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          DIS_APP_EvtRx(&DISHandleNotification);
          BLS_APP_EvtRx(&BLSHandleNotification);
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_BLOOD_PRESSURE; /* FW ID */
